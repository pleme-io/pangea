  ...
  module Resources
    module AWS
      ...
      def aws_ec2_availability_zone_group(name, attributes = {})
        ...
        attrs = Types::AwsEc2AvailabilityZoneGroupAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_availability_zone_group, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_ec2_availability_zone_group.#{name}.id}"
