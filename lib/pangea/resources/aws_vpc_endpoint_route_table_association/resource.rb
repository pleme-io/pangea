  ...
  module Resources
    module AWS
      ...
      def aws_vpc_endpoint_route_table_association(name, attributes = {})
        ...
        attrs = Types::AwsVpcEndpointRouteTableAssociationAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_vpc_endpoint_route_table_association, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_vpc_endpoint_route_table_association.#{name}.id}"
