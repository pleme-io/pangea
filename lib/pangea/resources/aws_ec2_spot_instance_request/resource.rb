  ...
  module Resources
    module AWS
      ...
      def aws_ec2_spot_instance_request(name, attributes = {})
        ...
        attrs = Types::AwsEc2SpotInstanceRequestAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_spot_instance_request, name) do
        ...
        ResourceReference.new(
          type: 'aws_ec2_spot_instance_request',
          name: name,
          resource_attributes: attrs.to_h,
          outputs: {
            id: "${aws_ec2_spot_instance_request.#{name}.id}"
