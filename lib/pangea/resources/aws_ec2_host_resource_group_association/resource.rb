  ...
  module Resources
    module AWS
      ...
      def aws_ec2_host_resource_group_association(name, attributes = {})
        ...
        attrs = Types::AwsEc2HostResourceGroupAssociationAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_host_resource_group_association, name) do
        ...
        ResourceReference.new(
          type: 'aws_ec2_host_resource_group_association',
          name: name,
          resource_attributes: attrs.to_h,
          outputs: {
            id: "${aws_ec2_host_resource_group_association.#{name}.id}"
