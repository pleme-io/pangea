  ...
  module Resources
    module AWS
      module ComprehendMedical
        module Jobs
          # AWS Comprehend Medical RxNorm Inference Job resource
          module RxNormInferenceJob
            ...
            #     input_data_config: { s3_bucket: "prescription-data", s3_key: "meds/" },
            #     output_data_config: { s3_bucket: "med-results", s3_key: "rxnorm-codes/" },
            #     data_access_role_arn: ref(:aws_iam_role, :medication_role, :arn),
            #     language_code: "en"
            #   })
            #
            ...
            def aws_comprehendmedical_rx_norm_inference_job(name, attributes = {})
              build_comprehendmedical_job(
                :aws_comprehendmedical_rx_norm_inference_job,
                name,
                attributes
              )
            end
