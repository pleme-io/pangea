  ...
  module Resources
    module AWS
      ...
      def aws_vpc_security_group_ingress_rule(name, attributes = {})
        ...
        attrs = Types::AwsVpcSecurityGroupIngressRuleAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_vpc_security_group_ingress_rule, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_vpc_security_group_ingress_rule.#{name}.id}"
