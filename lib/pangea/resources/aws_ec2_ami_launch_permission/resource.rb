  ...
  module Resources
    module AWS
      ...
      def aws_ec2_ami_launch_permission(name, attributes = {})
        ...
        attrs = Types::AwsEc2AmiLaunchPermissionAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_ami_launch_permission, name) do
        ...
        ResourceReference.new(
          type: 'aws_ec2_ami_launch_permission',
          name: name,
          resource_attributes: attrs.to_h,
          outputs: {
            id: "${aws_ec2_ami_launch_permission.#{name}.id}"
