# AwsTimestreamBatchLoadTask Implementation Documentation

## Overview

This directory contains the implementation for the `aws_timestream_batch_load_task` resource function, providing type-safe creation and management of Timestream Batch Load Task resources through terraform-synthesizer integration.
...
The main `aws_timestream_batch_load_task` function that:
...
TimestreamBatchLoadTaskAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_timestream_batch_load_task" do
