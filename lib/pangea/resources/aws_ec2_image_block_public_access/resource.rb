  ...
  module Resources
    module AWS
      ...
      def aws_ec2_image_block_public_access(name, attributes = {})
        ...
        attrs = Types::AwsEc2ImageBlockPublicAccessAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_image_block_public_access, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_ec2_image_block_public_access.#{name}.id}"
