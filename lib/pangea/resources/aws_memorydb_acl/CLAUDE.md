# AwsMemorydbAcl Implementation Documentation

## Overview

This directory contains the implementation for the `aws_memorydb_acl` resource function, providing type-safe creation and management of Memorydb Acl resources through terraform-synthesizer integration.
...
The main `aws_memorydb_acl` function that:
...
MemorydbAclAttributes dry-struct defining:
