  ...
  module Resources
    module AWS
      ...
      def aws_ec2_capacity_block_reservation(name, attributes = {})
        ...
        attrs = Types::AwsEc2CapacityBlockReservationAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_capacity_block_reservation, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_ec2_capacity_block_reservation.#{name}.id}"
