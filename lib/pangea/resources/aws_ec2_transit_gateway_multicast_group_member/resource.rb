  ...
  module Resources
    module AWS
      ...
      def aws_ec2_transit_gateway_multicast_group_member(name, attributes = {})
        ...
        attrs = Types::AwsEc2TransitGatewayMulticastGroupMemberAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_transit_gateway_multicast_group_member, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_ec2_transit_gateway_multicast_group_member.#{name}.id}"
