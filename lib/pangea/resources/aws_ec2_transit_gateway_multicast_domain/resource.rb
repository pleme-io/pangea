  ...
  module Resources
    module AWS
      ...
      def aws_ec2_transit_gateway_multicast_domain(name, attributes = {})
        ...
        attrs = Types::AwsEc2TransitGatewayMulticastDomainAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_transit_gateway_multicast_domain, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_ec2_transit_gateway_multicast_domain.#{name}.id}"
