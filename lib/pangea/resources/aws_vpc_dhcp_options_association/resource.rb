  ...
  module Resources
    module AWS
      ...
      def aws_vpc_dhcp_options_association(name, attributes = {})
        ...
        attrs = Types::AwsVpcDhcpOptionsAssociationAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_vpc_dhcp_options_association, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_vpc_dhcp_options_association.#{name}.id}"
