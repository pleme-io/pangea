  ...
  module Resources
    module AWS
      ...
      def aws_vpc_security_group_egress_rule(name, attributes = {})
        ...
        attrs = Types::AwsVpcSecurityGroupEgressRuleAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_vpc_security_group_egress_rule, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_vpc_security_group_egress_rule.#{name}.id}"
