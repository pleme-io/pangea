# AwsEipAssociation Implementation Documentation

## Overview

This directory contains the implementation for the `aws_eip_association` resource function, providing type-safe creation and management of Eip Association resources through terraform-synthesizer integration.
...
The main `aws_eip_association` function that:
...
EipAssociationAttributes dry-struct defining:
