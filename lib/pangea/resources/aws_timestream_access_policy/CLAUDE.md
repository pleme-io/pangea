# AwsTimestreamAccessPolicy Implementation Documentation

## Overview

This directory contains the implementation for the `aws_timestream_access_policy` resource function, providing type-safe creation and management of Timestream Access Policy resources through terraform-synthesizer integration.
...
The main `aws_timestream_access_policy` function that:
...
TimestreamAccessPolicyAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_timestream_access_policy" do
