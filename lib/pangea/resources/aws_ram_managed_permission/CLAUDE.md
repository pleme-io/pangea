# AwsRamManagedPermission Implementation Documentation

## Overview

This directory contains the implementation for the `aws_ram_managed_permission` resource function, providing type-safe creation and management of Ram Managed Permission resources through terraform-synthesizer integration.
...
The main `aws_ram_managed_permission` function that:
...
RamManagedPermissionAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_ram_managed_permission" do
