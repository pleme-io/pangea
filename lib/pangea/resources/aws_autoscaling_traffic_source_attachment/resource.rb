  ...
  module Resources
    module AWS
      ...
      def aws_autoscaling_traffic_source_attachment(name, attributes = {})
        ...
        attrs = Types::AwsAutoscalingTrafficSourceAttachmentAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_autoscaling_traffic_source_attachment, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_autoscaling_traffic_source_attachment.#{name}.id}"
