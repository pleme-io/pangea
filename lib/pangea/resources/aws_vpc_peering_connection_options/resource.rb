  ...
  module Resources
    module AWS
      ...
      def aws_vpc_peering_connection_options(name, attributes = {})
        ...
        attrs = Types::AwsVpcPeeringConnectionOptionsAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_vpc_peering_connection_options, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_vpc_peering_connection_options.#{name}.id}"
