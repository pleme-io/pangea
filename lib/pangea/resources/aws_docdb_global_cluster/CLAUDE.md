# AwsDocdbGlobalCluster Implementation Documentation

## Overview

This directory contains the implementation for the `aws_docdb_global_cluster` resource function, providing type-safe creation and management of Docdb Global Cluster resources through terraform-synthesizer integration.
...
The main `aws_docdb_global_cluster` function that:
...
DocdbGlobalClusterAttributes dry-struct defining:
