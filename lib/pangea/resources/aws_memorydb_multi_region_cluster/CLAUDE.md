# AwsMemorydbMultiRegionCluster Implementation Documentation

## Overview

This directory contains the implementation for the `aws_memorydb_multi_region_cluster` resource function, providing type-safe creation and management of Memorydb Multi Region Cluster resources through terraform-synthesizer integration.
...
The main `aws_memorydb_multi_region_cluster` function that:
...
MemorydbMultiRegionClusterAttributes dry-struct defining:
