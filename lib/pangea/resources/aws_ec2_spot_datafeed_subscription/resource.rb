  ...
  module Resources
    module AWS
      ...
      def aws_ec2_spot_datafeed_subscription(name, attributes = {})
        ...
        attrs = Types::AwsEc2SpotDatafeedSubscriptionAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_spot_datafeed_subscription, name) do
        ...
        ResourceReference.new(
          type: 'aws_ec2_spot_datafeed_subscription',
          name: name,
          resource_attributes: attrs.to_h,
          outputs: {
            id: "${aws_ec2_spot_datafeed_subscription.#{name}.id}"
