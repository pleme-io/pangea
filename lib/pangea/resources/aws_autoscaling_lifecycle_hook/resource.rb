  ...
  module Resources
    module AWS
      ...
      def aws_autoscaling_lifecycle_hook(name, attributes = {})
        ...
        attrs = Types::AwsAutoscalingLifecycleHookAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_autoscaling_lifecycle_hook, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_autoscaling_lifecycle_hook.#{name}.id}"
