  ...
  module Resources
    module AWS
      ...
      def aws_ec2_dedicated_host(name, attributes = {})
        ...
        attrs = Types::AwsEc2DedicatedHostAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_dedicated_host, name) do
        ...
        ResourceReference.new(
          type: 'aws_ec2_dedicated_host',
          name: name,
          resource_attributes: attrs.to_h,
          outputs: {
            id: "${aws_ec2_dedicated_host.#{name}.id}"
