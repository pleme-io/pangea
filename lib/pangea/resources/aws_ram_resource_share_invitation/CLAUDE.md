# AwsRamResourceShareInvitation Implementation Documentation

## Overview

This directory contains the implementation for the `aws_ram_resource_share_invitation` resource function, providing type-safe creation and management of Ram Resource Share Invitation resources through terraform-synthesizer integration.
...
The main `aws_ram_resource_share_invitation` function that:
...
RamResourceShareInvitationAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_ram_resource_share_invitation" do
