  ...
  module Resources
    module AWS
      ...
      def aws_vpc_network_performance_metric_subscription(name, attributes = {})
        ...
        attrs = Types::AwsVpcNetworkPerformanceMetricSubscriptionAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_vpc_network_performance_metric_subscription, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_vpc_network_performance_metric_subscription.#{name}.id}"
