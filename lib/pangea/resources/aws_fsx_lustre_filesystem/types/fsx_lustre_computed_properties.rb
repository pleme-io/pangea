...
module Pangea
  module Resources
    module AWS
      module Types
        # Computed properties for FSx Lustre file system attributes
        module FsxLustreComputedProperties
          def is_persistent?
          ...
          def estimated_monthly_cost
            ...
            {
              storage: storage_cost.round(2),
              throughput: throughput_cost.round(2),
              total: (storage_cost + throughput_cost).round(2)
            }
          end
          ...
          def calculate_throughput_cost
            ...
            throughput_multiplier = throughput_cost_multiplier
            (storage_capacity / 1024.0) * throughput_multiplier * 730
          end

          def throughput_cost_multiplier
            case per_unit_storage_throughput
            when 50 then 0
            when 100 then 0.035
            when 200 then 0.070
            when 500 then 0.175
