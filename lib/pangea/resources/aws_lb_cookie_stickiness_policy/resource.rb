  ...
  module Resources
    module AWS
      ...
      def aws_lb_cookie_stickiness_policy(name, attributes = {})
        ...
        attrs = Types::AwsLbCookieStickinessPolicyAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_lb_cookie_stickiness_policy, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_lb_cookie_stickiness_policy.#{name}.id}"
