# AwsRamSharingWithOrganization Implementation Documentation

## Overview

This directory contains the implementation for the `aws_ram_sharing_with_organization` resource function, providing type-safe creation and management of Ram Sharing With Organization resources through terraform-synthesizer integration.
...
The main `aws_ram_sharing_with_organization` function that:
...
RamSharingWithOrganizationAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_ram_sharing_with_organization" do
