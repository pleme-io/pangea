  ...
  module Resources
    module AWS
      ...
      def aws_autoscaling_policy_step_adjustment(name, attributes = {})
        ...
        attrs = Types::AwsAutoscalingPolicyStepAdjustmentAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_autoscaling_policy_step_adjustment, name) do
        ...
        ResourceReference.new(
          type: 'aws_autoscaling_policy_step_adjustment',
          name: name,
          resource_attributes: attrs.to_h,
          outputs: {
            id: "${aws_autoscaling_policy_step_adjustment.#{name}.id}"
