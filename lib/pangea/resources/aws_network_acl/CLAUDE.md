# AwsNetworkAcl Implementation Documentation

## Overview

This directory contains the implementation for the `aws_network_acl` resource function, providing type-safe creation and management of Network Acl resources through terraform-synthesizer integration.
...
The main `aws_network_acl` function that:
...
NetworkAclAttributes dry-struct defining:
