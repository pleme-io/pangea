# AwsMemorydbClusterEndpoint Implementation Documentation

## Overview

This directory contains the implementation for the `aws_memorydb_cluster_endpoint` resource function, providing type-safe creation and management of Memorydb Cluster Endpoint resources through terraform-synthesizer integration.
...
The main `aws_memorydb_cluster_endpoint` function that:
...
MemorydbClusterEndpointAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_memorydb_cluster_endpoint" do
