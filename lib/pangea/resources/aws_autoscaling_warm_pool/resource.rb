  ...
  module Resources
    module AWS
      ...
      def aws_autoscaling_warm_pool(name, attributes = {})
        ...
        attrs = Types::AwsAutoscalingWarmPoolAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_autoscaling_warm_pool, name) do
        ...
        ResourceReference.new(
          type: 'aws_autoscaling_warm_pool',
          name: name,
          resource_attributes: attrs.to_h,
          outputs: {
            id: "${aws_autoscaling_warm_pool.#{name}.id}"
