  ...
  module Resources
    module AWS
      ...
      def aws_ec2_instance_metadata_defaults(name, attributes = {})
        ...
        attrs = Types::AwsEc2InstanceMetadataDefaultsAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_instance_metadata_defaults, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_ec2_instance_metadata_defaults.#{name}.id}"
