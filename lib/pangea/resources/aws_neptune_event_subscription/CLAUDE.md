# AwsNeptuneEventSubscription Implementation Documentation

## Overview

This directory contains the implementation for the `aws_neptune_event_subscription` resource function, providing type-safe creation and management of Neptune Event Subscription resources through terraform-synthesizer integration.
...
The main `aws_neptune_event_subscription` function that:
...
NeptuneEventSubscriptionAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_neptune_event_subscription" do
