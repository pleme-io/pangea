# AwsLicensemanagerReportGenerator Implementation Documentation

## Overview

This directory contains the implementation for the `aws_licensemanager_report_generator` resource function, providing type-safe creation and management of Licensemanager Report Generator resources through terraform-synthesizer integration.
...
The main `aws_licensemanager_report_generator` function that:
...
LicensemanagerReportGeneratorAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_licensemanager_report_generator" do
