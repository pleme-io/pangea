  ...
  module Resources
    module AWS
      ...
      def aws_load_balancer_backend_server_policy(name, attributes = {})
        ...
        attrs = Types::AwsLoadBalancerBackendServerPolicyAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_load_balancer_backend_server_policy, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_load_balancer_backend_server_policy.#{name}.id}"
