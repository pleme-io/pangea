  ...
  module Resources
    module AWS
      ...
      def aws_ec2_transit_gateway_multicast_domain_association(name, attributes = {})
        ...
        attrs = Types::AwsEc2TransitGatewayMulticastDomainAssociationAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_transit_gateway_multicast_domain_association, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_ec2_transit_gateway_multicast_domain_association.#{name}.id}"
