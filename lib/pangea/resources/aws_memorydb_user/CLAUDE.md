# AwsMemorydbUser Implementation Documentation

## Overview

This directory contains the implementation for the `aws_memorydb_user` resource function, providing type-safe creation and management of Memorydb User resources through terraform-synthesizer integration.
...
The main `aws_memorydb_user` function that:
...
MemorydbUserAttributes dry-struct defining:
