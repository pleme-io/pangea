  ...
  module Resources
    module AWS
      ...
      def aws_ec2_snapshot_block_public_access(name, attributes = {})
        ...
        attrs = Types::AwsEc2SnapshotBlockPublicAccessAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_ec2_snapshot_block_public_access, name) do
        ...
        ResourceReference.new(
          type: 'aws_ec2_snapshot_block_public_access',
          name: name,
          resource_attributes: attrs.to_h,
          outputs: {
            id: "${aws_ec2_snapshot_block_public_access.#{name}.id}"
