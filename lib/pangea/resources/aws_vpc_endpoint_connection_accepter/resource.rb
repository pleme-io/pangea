  ...
  module Resources
    module AWS
      ...
      def aws_vpc_endpoint_connection_accepter(name, attributes = {})
        ...
        attrs = Types::AwsVpcEndpointConnectionAccepterAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_vpc_endpoint_connection_accepter, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_vpc_endpoint_connection_accepter.#{name}.id}"
