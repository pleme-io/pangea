# AwsTimestreamScheduledQuery Implementation Documentation

## Overview

This directory contains the implementation for the `aws_timestream_scheduled_query` resource function, providing type-safe creation and management of Timestream Scheduled Query resources through terraform-synthesizer integration.
...
The main `aws_timestream_scheduled_query` function that:
...
TimestreamScheduledQueryAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_timestream_scheduled_query" do
