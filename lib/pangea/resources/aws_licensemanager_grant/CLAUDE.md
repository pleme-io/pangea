# AwsLicensemanagerGrant Implementation Documentation

## Overview

This directory contains the implementation for the `aws_licensemanager_grant` resource function, providing type-safe creation and management of Licensemanager Grant resources through terraform-synthesizer integration.
...
The main `aws_licensemanager_grant` function that:
...
LicensemanagerGrantAttributes dry-struct defining:
