# AwsRamResourceShare Implementation Documentation

## Overview

This directory contains the implementation for the `aws_ram_resource_share` resource function, providing type-safe creation and management of Ram Resource Share resources through terraform-synthesizer integration.
...
The main `aws_ram_resource_share` function that:
...
RamResourceShareAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_ram_resource_share" do
