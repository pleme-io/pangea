  ...
  module Resources
    module AWS
      ...
      def aws_vpc_endpoint_subnet_association(name, attributes = {})
        ...
        attrs = Types::AwsVpcEndpointSubnetAssociationAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_vpc_endpoint_subnet_association, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_vpc_endpoint_subnet_association.#{name}.id}"
