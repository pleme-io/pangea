# AwsRoute Implementation Documentation

## Overview

This directory contains the implementation for the `aws_route` resource function, providing type-safe creation and management of Route resources through terraform-synthesizer integration.
...
The main `aws_route` function that:
...
RouteAttributes dry-struct defining:
