      ...
      module DynamoDBTable
        ...
        module TableBuilder
          ...
          def build_table(context, attrs)
            ...
            build_indexes(context, attrs)
            build_optional_features(context, attrs)
            build_restore_config(context, attrs)
            build_import_config(context, attrs)
            build_replicas(context, attrs)
            build_tags(context, attrs)
          end
