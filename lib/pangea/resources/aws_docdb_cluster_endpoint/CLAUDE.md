# AwsDocdbClusterEndpoint Implementation Documentation

## Overview

This directory contains the implementation for the `aws_docdb_cluster_endpoint` resource function, providing type-safe creation and management of Docdb Cluster Endpoint resources through terraform-synthesizer integration.
...
The main `aws_docdb_cluster_endpoint` function that:
...
DocdbClusterEndpointAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_docdb_cluster_endpoint" do
