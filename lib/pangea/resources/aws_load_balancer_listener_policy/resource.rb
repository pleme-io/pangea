  ...
  module Resources
    module AWS
      ...
      def aws_load_balancer_listener_policy(name, attributes = {})
        ...
        attrs = Types::AwsLoadBalancerListenerPolicyAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_load_balancer_listener_policy, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_load_balancer_listener_policy.#{name}.id}"
