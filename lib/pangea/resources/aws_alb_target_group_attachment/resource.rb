  ...
  module Resources
    module AWS
      ...
      def aws_alb_target_group_attachment(name, attributes = {})
        ...
        attrs = Types::AwsAlbTargetGroupAttachmentAttributes.new(attributes)
        
        # Generate terraform resource block via terraform-synthesizer
        resource(:aws_alb_target_group_attachment, name) do
        ...
        ResourceReference.new(
          ...
          outputs: {
            id: "${aws_alb_target_group_attachment.#{name}.id}"
