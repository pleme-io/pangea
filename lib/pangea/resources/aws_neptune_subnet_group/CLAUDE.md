# AwsNeptuneSubnetGroup Implementation Documentation

## Overview

This directory contains the implementation for the `aws_neptune_subnet_group` resource function, providing type-safe creation and management of Neptune Subnet Group resources through terraform-synthesizer integration.
...
The main `aws_neptune_subnet_group` function that:
...
NeptuneSubnetGroupAttributes dry-struct defining:
...
```ruby
resource(:aws_neptune_subnet_group, name) do
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_neptune_subnet_group" do
