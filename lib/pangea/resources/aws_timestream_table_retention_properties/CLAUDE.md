# AwsTimestreamTableRetentionProperties Implementation Documentation

## Overview

This directory contains the implementation for the `aws_timestream_table_retention_properties` resource function, providing type-safe creation and management of Timestream Table Retention Properties resources through terraform-synthesizer integration.
...
The main `aws_timestream_table_retention_properties` function that:
...
TimestreamTableRetentionPropertiesAttributes dry-struct defining:
...
RSpec.describe Pangea::Resources::AWS do
  describe "#aws_timestream_table_retention_properties" do
