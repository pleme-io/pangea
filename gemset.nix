{
  ...
  aws-sdk-kms = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1gmvshmb2m03230apd4shrwk32l1mg69fznvl16hn70bbcdwca72";
      type = "gem";
    };
    version = "1.98.0";
  };
  aws-sdk-s3 = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0v66s1s9vdcjipqhflh44j6yb9ydh2vbazbrllwgwsxkjjk4anik";
      type = "gem";
    };
    version = "1.180.0";
  };
  ...
  solargraph = {
    dependencies = ["backport" "benchmark" "diff-lcs" "jaro_winkler" "kramdown" "kramdown-parser-gfm" "logger" "observer" "ostruct" "parser" "rbs" "reverse_markdown" "rubocop" "thor" "tilt" "yard"];
    groups = ["development"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "08lynkkps22vklil2sbj1pq6fb49vq6bnai77n2i6djwcd4ccqn3";
      type = "gem";
    };
    version = "0.51.2";
  };
